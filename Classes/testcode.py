...
x.set_location_name("Singapore")
x.set_location_address("Singapore")
x.set_offer("https://www.letsrecoveronline.com/sober-dance")
x.set_start_date("03-06-2021")
x.set_url("https://www.letsrecoveronline.com/sober-dance")
x.set_name("Sober Dance")
