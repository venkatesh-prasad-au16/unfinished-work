...
class Organization:
    ...
    def dump_schema(self):
        ...
        self.d['name'] = "Let's recover online"
        self.d['email'] = 'marn@letsrecoveronline.com'
        self.d['telephone'] = '+6590105908'
        self.d['founder'] = 'Marn Lim'
        self.d['address'] = '89D Lorong H Telok Kurau Road Singapore 426104'
        self.d['location'] = 'Singapore'
